...
| BE-03 / blocked (сверка выполнена с замечаниями) | Backend / DATA / владелец данных | partner, opt-in tests, DATA_LIMITATIONS: сверка реальных архивов | `af32ab3`; ошибки MOQ/количеств IEK, конфликт кратности Systeme, неподтверждённые бизнес-входы; см. handoffs/backend.md |
...
BE-03 включает D4 из AGENT_PLAN: команда получила оригиналы и выполнила техническую
сверку с замечаниями. На актуальном адаптере полный импорт IEK остаётся заблокирован
ошибками исходных значений; конфликт происхождения MOQ Systeme требует решения DATA.
